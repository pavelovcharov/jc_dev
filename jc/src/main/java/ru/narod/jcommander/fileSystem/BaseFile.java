...
public interface BaseFile {
    ...
    /**
     * Получить отфильтрованный список файлов, если данный объект является
     * каталогом.
     *
     * @return список файлов в данном каталоге
     */
    ...
    /**
     * Получить файл, соответствующий корню диска ('C:\', 'D:\' и т.д. для
     * Windows, '/' для Linux)
     *
     ...
     * @throws java.io.IOException исключение вызывается, если при созданни
     * файла произошли ошибки
     */

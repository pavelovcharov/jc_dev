...
import ru.narod.jcommander.gui.search.SearchDialog;
...
import ru.narod.jcommander.gui.table.dragdrop.FileTransferHandler;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    public final ru.narod.jcommander.actions.Action ACTION_COPY = new ActionCopy(this);
    public final ru.narod.jcommander.actions.Action ACTION_TAB = new ActionTab(this);
    public final ru.narod.jcommander.actions.Action ACTION_VIEW = new ActionView(this);
    public final ru.narod.jcommander.actions.Action ACTION_EDIT = new ActionEdit(this);
    public final ru.narod.jcommander.actions.Action ACTION_NEW_FILE = new ActionNewFile(this);
    public final ru.narod.jcommander.actions.Action ACTION_NEW_DIR = new ActionNewDir(this);
    public final ru.narod.jcommander.actions.Action ACTION_PARENT_DIR = new ActionParentDir(this);
    public final ru.narod.jcommander.actions.Action ACTION_MOVE = new ActionMove(this);
    public final ru.narod.jcommander.actions.Action ACTION_SELECT_ALL = new ActionSelectAll(this);
    public final ru.narod.jcommander.actions.Action ACTION_SYNC = new ActionSync(this);
    public final ru.narod.jcommander.actions.Action ACTION_RENAME = new ActionRename(this);
    public final ru.narod.jcommander.actions.Action ACTION_SHOW_LEFT_COMBO = new ActionShowComboBox(this, true);
    public final ru.narod.jcommander.actions.Action ACTION_SHOW_RIGHT_COMBO = new ActionShowComboBox(this, false);
    public final ru.narod.jcommander.actions.Action ACTION_SELECT_N_DOWN = new ActionSelectNDown(this);
    public final ru.narod.jcommander.actions.Action ACTION_SELECT_N_UP = new ActionSelectNUp(this);
    public final ru.narod.jcommander.actions.Action ACTION_PACK = new ActionPack(this);
    public final ru.narod.jcommander.actions.Action ACTION_DELETE = new ActionDelete(this);
    public final ru.narod.jcommander.actions.Action ACTION_REFRESH = new ActionRefresh(this);
    public final ru.narod.jcommander.actions.Action ACTION_ACTIVATE_LEFT_TABLE = new ActionActivateTable(this, true);
    public final ru.narod.jcommander.actions.Action ACTION_ACTIVATE_RIGHT_TABLE = new ActionActivateTable(this, false);
    public final ru.narod.jcommander.actions.Action ACTION_UP = new ActionUp(this);
    public final ru.narod.jcommander.actions.Action ACTION_DOWN = new ActionDown(this);
    public final ru.narod.jcommander.actions.Action ACTION_JUMP_UP = new ActionJump(this, true);
    public final ru.narod.jcommander.actions.Action ACTION_JUMP_DOWN = new ActionJump(this, false);
    public final ru.narod.jcommander.actions.Action ACTION_FIRST = new ActionFirst(this);
    public final ru.narod.jcommander.actions.Action ACTION_LAST = new ActionLast(this);
    public final ru.narod.jcommander.actions.Action ACTION_EXIT = new ActionExit(this);
    public final ru.narod.jcommander.actions.Action ACTION_FIND = new ActionFind(this);
    public final ru.narod.jcommander.actions.Action ACTION_SHOW_PANELS = new ActionShowPanels(this);
    public final ru.narod.jcommander.actions.Action ACTION_QUICK_SEARCH = new ActionQuickSearch(this);
    public final ru.narod.jcommander.actions.Action ACTION_CALC_SIZE = new ActionCalcSize(this);
    public final ru.narod.jcommander.actions.Action ACTION_ADD_TAB = new ActionAddTab(this);
    public final ru.narod.jcommander.actions.Action ACTION_REMOVE_TAB = new ActionRemoveTab(this);
    public final ru.narod.jcommander.actions.Action ACTION_NEXT_TAB = new ActionNextTab(this);
    public final ru.narod.jcommander.actions.Action ACTION_PREV_TAB = new ActionPrevTab(this);
    public final ru.narod.jcommander.actions.Action ACTION_COPY_NAME = new ActionCopyName(this);
    public final ru.narod.jcommander.actions.Action ACTION_COPY_PATH = new ActionCopyPath(this);
    public final ru.narod.jcommander.actions.Action ACTION_DECODE_HEX = new ActionDecodeHex(this);
    public final ru.narod.jcommander.actions.Action ACTION_GOTO_CMDLINE = new ActionGotoCmdLine(this);
    public final ru.narod.jcommander.actions.Action ACTION_ENTER = new ActionEnter(this);
    public final ru.narod.jcommander.actions.Action ACTION_SWAP = new ActionSwap(this);
    public final ru.narod.jcommander.actions.Action ACTION_CHANGE_ARRANGEMENT = new ActionChangeArrangement(this);
    public final ru.narod.jcommander.actions.Action ACTION_COPY_SAME_FOLDER = new ActionCopySameFolder(this);
    public final ru.narod.jcommander.actions.Action ACTION_EXPLORER = new ActionExplorer(this);
    public final ru.narod.jcommander.actions.Action ACTION_MOVE_TO_TRASH = new ActionMoveToTrash((this));
    // </editor-fold>
    ...
    public void viewFile(BaseFile file) {
        ...
        ru.narod.jcommander.editor.Editor editor = new ru.narod.jcommander.editor.Editor(this);

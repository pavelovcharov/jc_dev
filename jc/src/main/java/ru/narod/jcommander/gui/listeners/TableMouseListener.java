...
/**
 * Класс для изменения состояния таблиц FileTable при двойном щелчке мыши. Если
 * двойной щелчок выполнен на каталоге в таблицу будет выведено содержимое этого
 * каталога. Если двойной щелчок выполнен на файле, данный файл будет запущен.
 * Помимо, состояния таблицы изменяется состояние строки статуса и пути.
 *
 * @author Programmer
...
public class TableMouseListener extends MouseInputAdapter {
     ...
     * //this.table = table; this.parent = parent; }
     */
